...
| Mail backend | `mail/` | FastAPI, SQLAlchemy (async, asyncpg), httpx→Gmail | Postgres (own DB `funnelmanager_mail`) | The browser (via nginx, `/api/mail/*`) + Google OAuth/Gmail REST |
